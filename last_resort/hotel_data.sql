CREATE DATABASE  IF NOT EXISTS `hotel_data` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `hotel_data`;
...
INSERT INTO `event` VALUES (1,3,2,'TechGlobal Q3 Summit',3,50,45),(2,6,5,'Johnson Rehearsal Dinner',4,30,0),(3,6,5,'Johnson Wedding Reception',6,150,100),(4,1,2,'TechGlobal Q3 Summit',3,50,45);
...
INSERT INTO `facility` VALUES (1,NULL,1,1,1,200,'Open',1),(2,NULL,1,2,5,50,'Open',2),(3,NULL,1,1,1,20,'Closed',10),(4,NULL,2,4,1,300,'Open',7),(5,NULL,1,3,1,80,'Open',3),(6,NULL,1,7,5,40,'Open',8),(7,NULL,1,14,2,120,'Open',7),(8,NULL,1,14,2,60,'Closed',7),(9,NULL,2,8,1,100,'Open',1),(10,NULL,2,10,1,500,'Reserved',7),(11,NULL,2,23,1,30,'Open',4),(12,NULL,3,11,1,15,'Open',2),(13,NULL,3,27,1,25,'Open',7),(14,NULL,3,26,1,10,'Closed',3),(15,NULL,4,16,1,120,'Open',1),(16,NULL,4,19,2,200,'Open',6),(17,NULL,4,18,1,50,'Closed',8),(18,NULL,5,23,1,25,'Open',4),(19,NULL,5,20,1,40,'Open',8),(20,NULL,5,22,1,60,'Open',9);
...
-- Dump completed on 2025-12-11  7:22:46
